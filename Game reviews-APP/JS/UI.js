export function displayDataGame(data) {
  let gamesBox = ``;
  for (let i = 0; i < data.length; i++) {
   ...
   <div data-id="${
     data[i].id
      ...
      <footer class="card-footer d-flex small hstack justify-content-between">
...
export function displayDetails(data) {
 ...
 <button id="closeButton" class="close-btn">X</button>
    ...
    <p>Category: <span class="badge bg-info"> ${data.genre}</span> </p>
    <p>Platform: <span class="badge bg-info"> ${data.platform}</span> </p>
